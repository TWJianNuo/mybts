...
def main_worker():
    ...
    args.expname = 'shapenet_352x768'
    args.checkpoint_path = '/home/shengjie/Documents/bts/tmp/{}/model-135500-best_L1Measure_0.05169'.format(args.expname)

    dist.init_process_group(backend='nccl', init_method='tcp://127.0.0.1:1234', world_size=1, rank=0)
    ...
    with torch.no_grad():
        for idx, entry in enumerate(entries):
            ...
            reduc8x8_scaled, reduc4x4_scaled, reduc2x2_scaled, reduc1x1, pred_shape = model(rgb)
