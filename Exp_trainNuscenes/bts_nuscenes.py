...
def main_worker(gpu, ngpus_per_node, args):
    ...
    while epoch < args.num_epochs:
        ...
        for step, sample_batched in enumerate(dataloader.data):
            ...
            # tensor2rgb(image, viewind=0).show()
            ...
            depth_est_resized = torch.nn.functional.interpolate(depth_est, scale_factor=2, mode='bilinear', align_corners=True)

            loss = silog_criterion.forward(depth_est_resized, depth_gt, mask.to(torch.bool))
            loss.backward()
