...
def online_eval(model, normoptizer_eval, dataloader_eval, gpu):
...
def main_worker(gpu, args):
    ...
    model.eval()
    online_eval(model=model, normoptizer_eval=normoptizer_eval, dataloader_eval=dataloader_eval, gpu=gpu)
