...
class IntDecoder(nn.Module):
    def __init__(self, num_ch_enc, nchannelout=[1, 1], additionalblocks=2):
        super(IntDecoder, self).__init__()

        assert additionalblocks >= 0
        self.modalities = ['variance', 'lambda']
        ...
        self.convs[('variance', 0)] = Conv3x3(self.num_ch_dec[0], self.nchannelout[0])
...
class IntNet(nn.Module):
    def __init__(self, args):
        ...
        self.decoder = IntDecoder(self.encoder.num_ch_enc, nchannelout=[1, 1], additionalblocks=2)
