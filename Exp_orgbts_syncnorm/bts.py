...
class bts(nn.Module):
    def __init__(self, params, feat_out_channels, num_features=512):
        ...
        self.bn4 = normfunc(num_features // 2, momentum=0.01, affine=True, eps=1.1e-5)
        self.conv4 = torch.nn.Sequential(nn.Conv2d(num_features // 2 + feat_out_channels[2], num_features // 2, 3, 1, 1, bias=False), nn.ELU())
        self.bn4_2 = normfunc(num_features // 2, momentum=0.01, affine=True, eps=1.1e-5)
        ...
        self.bn3 = normfunc(num_features // 4, momentum=0.01, affine=True, eps=1.1e-5)
        ...
        self.bn2 = normfunc(num_features // 8, momentum=0.01, affine=True, eps=1.1e-5)
